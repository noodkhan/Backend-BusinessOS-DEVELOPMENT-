...
router.get('/profile/:id', memberController.getProfileByID);

// Courses API
router.get('/courses' , memberController.getCourses) ; 
router.get('/courses/:id' , memberController.getCourseByID) ;
router.get('/rounds/:id' , memberController.getRoundByID) ;

// ดึงข้อมูลโปรไฟล์
router.get('/profile', memberController.getProfile);
// อัพเดตข้อมูลส่วนตัว
router.put('/profile/:id', memberController.updateProfileById);

// router.post('/uploadprofile', upload.single('profile'), memberController.uploadProfileImage);

// อัพเดตที่อยู่
router.put('/update-address', memberController.updateAddress);

// อัพโหลดรูปโปรไฟล์
router.post("/uploadprofile/:memberId", upload.single("profile"), memberController.uploadProfileImage);
